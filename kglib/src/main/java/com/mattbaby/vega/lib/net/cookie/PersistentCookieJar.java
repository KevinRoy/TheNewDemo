...
import com.mattbaby.vega.lib.net.cookie.cache.CookieCache;
import com.mattbaby.vega.lib.net.cookie.cache.SetCookieCache;
import com.mattbaby.vega.lib.net.cookie.persistence.CookiePersistor;
...
public class PersistentCookieJar implements ClearableCookieJar {
    ...
    synchronized public List<Cookie> loadForRequest(HttpUrl url) {
        ...
        CookieManager.INSTANCE.saveCookie(validCookies);
        LogUtils.d("validCookies" + validCookies.toString());
        return validCookies;
    }
