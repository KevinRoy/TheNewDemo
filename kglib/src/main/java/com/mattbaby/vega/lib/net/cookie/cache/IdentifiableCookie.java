...
package com.mattbaby.vega.lib.net.cookie.cache;
...
class IdentifiableCookie {
    ...
    public boolean equals(Object other) {
        ...
        return that.cookie.name().equals(this.cookie.name())
                && that.cookie.value().equals(this.cookie.value())
                && that.cookie.domain().equals(this.cookie.domain())
                && that.cookie.path().equals(this.cookie.path())
                && that.cookie.expiresAt() == this.cookie.expiresAt()
                && that.cookie.secure() == this.cookie.secure()
                && that.cookie.httpOnly() == this.cookie.httpOnly()
                && that.cookie.persistent() == this.cookie.persistent()
