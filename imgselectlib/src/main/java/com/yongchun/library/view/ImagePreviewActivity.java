...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_CLICK = "isClickable";
    ...
    public boolean isNetworkImage;//图片为网络图片_没有选择的视图
     ...
     * 点击查看图片
     *
     * @param isNetworkImage true表示显示网络图片
     */
    public static void startPreview(Activity context, List<LocalMedia> images, int position, boolean isNetworkImage) {
        Intent intent = new Intent(context, ImagePreviewActivity.class);
        intent.putExtra(EXTRA_PREVIEW_LIST, (ArrayList) images);
        intent.putExtra(EXTRA_POSITION, position);
        intent.putExtra(EXTRA_CLICK, isNetworkImage);
    ...
    public void initView() {
        ...
        isNetworkImage = getIntent().getBooleanExtra(EXTRA_CLICK, false);
